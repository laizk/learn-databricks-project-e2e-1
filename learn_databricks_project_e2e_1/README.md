# learn_databricks_project_e2e_1

The 'learn_databricks_project_e2e_1' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] learn_databricks_project_e2e_1_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/learn_databricks_project_e2e_1.job.yml). The schedule
